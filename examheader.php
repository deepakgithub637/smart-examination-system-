                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <script type="text/javascript">
                                function confirm_alert(node) {
                                  return confirm("Congratulations on doing so well in your exam!!!");
                                }
                            </script>
                            <li><a href="home.php" id="endExamBtn" onclick="return confirm_alert(this)"> <i class="fa fa-sign-out fa-fw"></i> End-Exam</a></li>                      
