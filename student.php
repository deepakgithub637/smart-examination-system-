...
if(isset($_REQUEST['btn']))
{
 ...
 // echo mysqli_num_rows($result);exit();
  ...
  {
    $_GLOBALS['message']="Sorry the Registration Number you entered is not available. Try with some other name.";
    ?>
    <script>
        alert('Sorry the Registration Number you entered is not available. Try with some other name');
    	...
    	<form  method="POST" enctype="multipart/form-data">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                           <h3 class="page-header" >Student Registration</h3> 
                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <form role="form">
                                                ...
                                                <div class="form-group">
                                                    <label>First Name<font color= "red" size= ".01px">*</font></label>
                                                 ...
                                                 <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>Last Name<font color= "red" size= ".01px">*</font></label>
                                                 ...
                                                 <div class="col-lg-6" >
                                                <div class="form-group">
                                                    <label>Gender<font color= "red" size= ".01px">*</font></label>
                                                    <div class="radio">
                                                        <label>
                                                 ...
                                                 <div class="col-lg-6">
                                                <div class="form-group">
            <label>Registration No. <font color= "red" size= ".01px">*        ENTER LAST 4 DIGIT OF REGD. NO</font></label>
            
              <input type="text" name="enroll" onkeyup="val()" class="form-control" id="enrollmentNumber" placeholder="Registration No." data-toggle="tooltip" data-placement="right" title="valid enroll" required/>
            </div>
          </div>
                                                ...
                                                <div class="form-group">
                                                  <div class="col-lg-6">
                                                  <label>Select Branch<font color= "red" size= ".01px">*</font></label>
                            ...
                            <option value="plastic">PLASTIC ENGINEERING</option>
                                                ...
                                                <div class="form-group">
                                                  <div class="col-lg-6">
            <label>Semester<font color= "red" size= ".01px">*</font> </label>
            ...
            <select name="sem" class="form-control" id="selectSemester" required>
              ...
              <option>8</option>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                    <label>Birth Date<font color= "red" size= ".01px">*</font></label>
                                                    <input class="form-control"name="dob" input type="date" onkeyup="val()"   required>
                                                    </div>
                                                </div>
                                                 <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>Mobile<font color= "red" size= ".01px">*</font></label>
                                                 ...
                                                 <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>Email<font color= "red" size= ".01px">*</font></label>
                                             ...
                                             <div class="col-lg-6">
                                                    <div class="form-group">
                                                    <label>Password<font color= "red" size= ".01px">*</font></label>
                                             ...
                                             <div class="col-lg-6">
                                                    <div class="form-group">
                                                    <label>Confirm Password<font color= "red" size= ".01px">*</font></label>
                                                    <input class="form-control"name="pswd_again" input type="password" placeholder="Enter password"   required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                    <label>Address<font color= "red" size= ".01px">*</font></label>
                                                    <textarea class="form-control" rows="3" name="address"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                    <label>city<font color= "red" size= ".01px">*</font></label>
